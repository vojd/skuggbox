...
/** Box: correct distance to corners, but in two dimensions (an endless box) */
...
/** Repeat space along one axis, but mirror every second cell so they match at the boundaries */
...
/** Repeat in two dimensions, but mirror every second cell so all boundaries match */
...
/** Repeat in two dimensions, but mirror every second cell at the diagonal as well */
